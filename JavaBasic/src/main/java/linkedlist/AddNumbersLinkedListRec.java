 ...
 * @author Nilesh
 */
public class AddNumbersLinkedListRec
{
    ...
    {
        AddNumbersLinkedListRec solution = new AddNumbersLinkedListRec();

//        int[] firstNumber  = {9,8,9,7,6}; // number: 98976
//        int[] secondNumber = {1,9,8}; // number: 198

        int[] firstNumber  = {7,6,5}; // number: 98976
        int[] secondNumber = {8}; // number: 198
